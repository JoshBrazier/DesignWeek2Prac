...
printf("Value after call to function1: %d\n", number);

/* C5. call function2 */
function2(&number);
/* C6. display the contents of number to the screen */
printf("Value after call to function2: %d\n", number);
return 0;
}
...
printf("Address in function2 is: %p\n", numberPtr);
...
printf("Value after increment in function2: %d\n", *numberPtr);
}